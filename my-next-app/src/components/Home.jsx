                ...
                <Grid container columns={{xs:8, md:12, lg:12}} spacing={4}>
                    {
                        data?.map((card, index) => (
                            <Grid item xs={3} key={index}>
                                    <ActionAreaCard title={card.text} date={card.date} avatar={card.owner.picture} description={card.description} name={card.name} image={card.image} firstname={card.owner.firstName} lastname={card.owner.lastName} >
                                    </ActionAreaCard>
